...
public class CreateVacancyForCompanyEndpoint :
    FastEndpoints.Endpoint<AddVacancyToCompanyRequest, Persistence.Abstraction.Models.Backoffice.Vacancy>
{
    ...
    public override async Task HandleAsync(AddVacancyToCompanyRequest req, CancellationToken ct)
    {
        ...
        var vacancy = await _vacancyRepository.AddVacancyToCompany(company, req.Vacancy);
